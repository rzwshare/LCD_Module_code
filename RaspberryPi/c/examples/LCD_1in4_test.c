...
void LCD_1IN4_test(void)
{
    // Exception handling:ctrl + c
    signal(SIGINT, Handler_1IN4_LCD);
    ...
    /* LCD Init */
	printf("1inch4 LCD demo...\r\n");
	LCD_1IN4_Init();
	LCD_1IN4_Clear(WHITE);
	LCD_SetBacklight(1010);
	
    UDOUBLE Imagesize = LCD_1IN4_HEIGHT*LCD_1IN4_WIDTH*2;
    UWORD *BlackImage;
    ...
    Paint_NewImage(BlackImage, LCD_1IN4_WIDTH, LCD_1IN4_HEIGHT, 0, WHITE, 16);
    Paint_Clear(WHITE);
    ...
    Paint_DrawString_EN(5, 90, "rzwshare", &Font20, RED, IMAGE_BACKGROUND);

    Paint_DrawNum(5, 160, 123456789, &Font20, GREEN, IMAGE_BACKGROUND);
	Paint_DrawString_CN(5,200, "î£ÖÇÍþ",  &Font24CN,IMAGE_BACKGROUND,BLUE);   
